...
class Modula_PRO_Settings {
	...
	public function modula_pro_fields( $fields ) {
		...
		if ( isset( $fields['general']['lightbox'] ) ) {
			...
			// Add all lightboxes
			if ( $fields['general']['lightbox']['values'][esc_html__( 'Lightboxes', 'modula-pro' )] ) {
				$fields['general']['lightbox']['values'][esc_html__( 'Lightboxes', 'modula-pro' )] = array(
	...
	public function change_limit( $image_limit, $images_count ) {
		...
		$image_limit = '<p style="margin-top:7px">' . $images_count . __( ' uploaded','modula-pro' ) . '</p>';
		echo $image_limit;
	}
